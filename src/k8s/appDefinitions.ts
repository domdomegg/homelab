...
export const apps: AppDefinition[] = [
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'esphome',
        image: 'ghcr.io/esphome/esphome:latest@sha256:a2784bc539dcf7529241bfe4425d645f1076031f9bf9ce07f5d59d1c45e9ff22',
        env: [{
  ...
  },
  {
    ...
    spec: {
      ...
      containers: [{
        name: 'music-assistant',
        image: 'ghcr.io/music-assistant/server:latest@sha256:f25ab51703e81e18c90d023916d2bc7c8b1ef98b99503644fc12277bacc69ecd',
        volumeMounts: [{
