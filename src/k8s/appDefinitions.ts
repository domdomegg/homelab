...
export const apps: AppDefinition[] = [
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'ha',
        image: 'ghcr.io/home-assistant/home-assistant:stable@sha256:9a5a3eb4a213dfb25932dee9dc6815c9305f78cecb5afa716fa2483163d8fb5b',
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'esphome',
        image: 'ghcr.io/esphome/esphome:latest@sha256:84d986f14c0e2807f6b572b367411bbdc6ed456f2350a1d00ea109233558d545',
        env: [{
