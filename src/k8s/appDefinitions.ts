...
export const apps: AppDefinition[] = [
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'ha',
        image: 'ghcr.io/home-assistant/home-assistant:stable@sha256:f8f13f6da9b38f6e33b9c40fded2a84ccd13ad69eb2a7e53bb045778fbccc229',
  ...
  },
  {
    ...
    spec: {
      containers: [{
        ...
        image: 'eclipse-mosquitto:latest@sha256:82512b0c9abd55041eb99c4620a7a8f4325317404671065d138393790818bf19',
        volumeMounts: [
          {
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'zigbee2mqtt',
        image: 'koenkk/zigbee2mqtt:latest@sha256:68e3cf365aee92e0cdc02cc537373cec380da544d187495f529d73d383a42205',
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'ddclient',
        image: 'linuxserver/ddclient:latest@sha256:ab0ccd4159df494d1b21b5f175e0271299d0d783d5cc2916e9256f593cfdebc5',
        volumeMounts: [
          {
