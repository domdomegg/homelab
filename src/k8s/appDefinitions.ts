...
export const apps: AppDefinition[] = [
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'ha',
        image: 'ghcr.io/home-assistant/home-assistant:stable@sha256:c36741490472518338323db8ee67775d7df70d2fa1f68eff9b9e63679fe64a18',
  ...
  },
  {
    ...
    spec: {
      containers: [{
        ...
        image: 'eclipse-mosquitto:latest@sha256:9fec559dbc89664d171ac8ea8230bbbeb50c2eb52615d631599ec31cbccbfb39',
        volumeMounts: [
          {
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'esphome',
        image: 'ghcr.io/esphome/esphome:latest@sha256:c6d4a461cb479b953bb9f6f4fb7844dc06ec8efd94c84fcb6d221597b54f24a9',
        env: [{
