...
export const apps: AppDefinition[] = [
  ...
  },
  {
    ...
    spec: {
      containers: [{
        ...
        image: 'eclipse-mosquitto:latest@sha256:21421af7b32bf9ce508e9090c8eb13bb81f410ca778dc205506180a6f862d0eb',
        volumeMounts: [
          {
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'esphome',
        image: 'ghcr.io/esphome/esphome:latest@sha256:da477c233316601d6b3e7a81ecb2e60a9c5f2ae3fc7799a2423153b20e3096a7',
        env: [{
