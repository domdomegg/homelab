...
export const apps: AppDefinition[] = [
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'ha',
        image: 'ghcr.io/home-assistant/home-assistant:stable@sha256:c35d4d5e2902172c7f7f3af6ab301d4f545130c85e050d66924d9045a1326502',
  ...
  },
  {
    ...
    spec: {
      containers: [{
        ...
        image: 'eclipse-mosquitto:latest@sha256:70fcbd8a064b1014a19e3757848993341285cb227a049e95ceab6e65887c70e0',
        volumeMounts: [
          {
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'zigbee2mqtt',
        image: 'koenkk/zigbee2mqtt:latest@sha256:8a893949ab01ea25fe1189a02a24f7fee3d7e8717d0973bd3dd6989a3a45a6bf',
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'ddclient',
        image: 'linuxserver/ddclient:latest@sha256:fc8e49a9e73f7002d6c44ab2f4ba7221cff94fcce15a768523a88506644b2f45',
        volumeMounts: [
          {
