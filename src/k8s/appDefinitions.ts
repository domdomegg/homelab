...
export const apps: AppDefinition[] = [
	...
	},
	{
		...
		spec: {
			containers: [{
				name: 'esphome',
				image: 'ghcr.io/esphome/esphome:latest@sha256:959ef36e5ea97c8309429f0ba1405ddb2eead19019b81e6e9518e683dff5191c',
				env: [{
	...
	},
	{
		...
		spec: {
			...
			containers: [{
				name: 'music-assistant',
				image: 'ghcr.io/music-assistant/server:latest@sha256:50666a6f8d7f87d53d993dc41860ab06dda11047f6e433bb5bdbcb6e309ac74c',
				volumeMounts: [{
