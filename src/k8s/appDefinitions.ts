...
export const apps: AppDefinition[] = [
  ...
  },
  {
    ...
    spec: {
      ...
      containers: [{
        name: 'ha',
        image: 'ghcr.io/home-assistant/home-assistant:stable@sha256:ceb1202133a5a036e8b03e20a10eb113186cc2f871968323c6fc6c3fc4205716',
  ...
  },
  {
    ...
    spec: {
      containers: [{
        name: 'esphome',
        image: 'ghcr.io/esphome/esphome:latest@sha256:8c101495f4764a8943c7f5a7a16a5a41f1e3c3e2192cc7f54305ce4511b557d5',
        env: [{
      ...
      containers: [{
        ...
        env: [{
          ...
          value: JSON.stringify({
            ...
            upstreams: [
              { name: 'gmail', displayName: 'Gmail', url: `https://gmail.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'google-cal', displayName: 'Google Calendar', url: `https://google-cal.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'google-contacts', displayName: 'Google Contacts', url: `https://google-contacts.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'google-documents', displayName: 'Google Docs', url: `https://google-documents.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'google-drive', displayName: 'Google Drive', url: `https://google-drive.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'google-maps-places', displayName: 'Google Maps', url: `https://google-maps-places.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'google-sheets', displayName: 'Google Sheets', url: `https://google-sheets.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'starling-bank', displayName: 'Starling Bank', url: `https://starling-bank.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'openfoodfacts', displayName: 'Open Food Facts', url: `https://openfoodfacts.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'olio', displayName: 'Olio', url: `https://olio.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'benepass', displayName: 'Benepass', url: `https://benepass.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'barcode-scanner', displayName: 'Barcode Scanner', url: `https://barcode-scanner.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'home-assistant', displayName: 'Home Assistant', url: `https://ha.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'tool-sandbox', displayName: 'Tool Sandbox', url: `https://tool-sandbox.mcp.${env.BASE_DOMAIN}/mcp` },
              { name: 'tunnel', displayName: 'Tunnel', url: `https://tunnel.mcp.${env.BASE_DOMAIN}/mcp` },
              {
                name: 'slack', displayName: 'Slack', url: 'https://mcp.slack.com/mcp', clientId: '825862040501.10898174083287',
              },
            ],
